...
class _ReportsScreenState extends State<ReportsScreen> {
            ...
            Row(
              children: [
                _reportCard(
                  ...
                  Icons.today_rounded,
                  AppColors.info,
                  'تقرير بالحالات والإيرادات اليومية',
                ),
                const SizedBox(width: 16),
                _reportCard(
                  'cases',
                  AppStrings.casesReport,
                  Icons.medical_services_rounded,
                  AppColors.secondary,
                  'تقرير شامل بجميع الحالات',
                ),
                const SizedBox(width: 16),
                _reportCard(
                  'revenue',
                  AppStrings.revenueReport,
  ...
  String _getReportTitle() {
    switch (_selectedReport) {
      ...
      case 'cases':
        return AppStrings.casesReport;
      case 'revenue':
        return AppStrings.revenueReport;
      case 'inventory':
        return AppStrings.inventoryReport;
      default:
        return AppStrings.dailyReport;
    }
  }
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: sel ? color.withValues(alpha: 0.1) : AppColors.surface,

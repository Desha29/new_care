...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  Future<void> _generateMonthlyReport() async {
    ...
    if (data == null) {
      UIFeedback.showWarning(context, 'لا توجد بيانات لإعداد التقرير');
      return;
    }
      ...
      body: BlocListener<AttendanceCubit, AttendanceState>(
        listener: (context, state) {
          if (state is AttendanceError) {
            ...
            UIFeedback.showSuccess(context, 'تم تسجيل الانصراف بنجاح');
          }
        },
          ...
          builder: (context, state) {
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  AttendanceHeader(
                    state: state is AttendanceLoaded ? state : null,
                    onRefresh: _loadData,
